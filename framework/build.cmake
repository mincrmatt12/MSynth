...
# FLAGS SETUP
set(COMMON_FLAGS "${COMMON_FLAGS} -Os --specs=nano.specs -nostdlib -mthumb -mcpu=cortex-m4 -ggdb3")
# check if the user specified they wanted the FPU enabled
if (${MSYNTH_USE_FPU})
	set(COMMON_FLAGS "${COMMON_FLAGS} -mfloat-abi=hard")
	message(STATUS "FPU is enabled")
endif()
...
#set(COMMON_FLAGS "${COMMON_FLAGS} -Wl,--gc-sections -Wl,-Map=out.map")
set(CMAKE_C_FLAGS "${CMAKE_C_FLAGS} ${COMMON_FLAGS}")
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} ${COMMON_FLAGS} -fno-exceptions -fno-rtti -Wno-register -Wno-pmf-conversions -Wno-volatile")
